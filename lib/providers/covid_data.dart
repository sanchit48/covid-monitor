...
class CovidData with ChangeNotifier {
  ...
  final List<CountryData> initialCountryList = [];
  ...
  Future<void> fetchCovidData() async {
    ...
    try{
      ...
      print("good");
        ...
        extractedData.forEach((map) {
          if(map["country"] != "World") {
            initialCountryList.add(CountryData(
              country: map['country'],
      ...
      initialCountryList.sort((a, b) => a.country.compareTo(b.country));
      for(CountryData c in initialCountryList) {
        if(countries.containsValue(c.country))
          countryList.add(c);
      }
      notifyListeners();
    }
